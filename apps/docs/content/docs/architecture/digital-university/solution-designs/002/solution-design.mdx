...
Per Activity Type:
- Scientific Rating = Σ (SCIENCE activities × coefficients)
- Methodological Rating = Σ (METHOD activities × coefficients)
- Organizational Rating = Σ (ORG activities × coefficients)

Total Rating = Scientific + Methodological + Organizational
```
