...
This C4 Level 2 diagram shows the technical building blocks (containers) that make up the NPP Portal.

<Diagram lang="plantuml" path="architecture/digital-university/c4/container.puml" alt="NPP Portal container diagram" />
