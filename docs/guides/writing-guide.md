...
```mdx
<!-- Good -->
See the [diagram usage guide](diagram-guide.md) for details.

<!-- Avoid -->
Click [here](diagram-guide.md) for details.
```
...
```mdx
<!-- Good -->
See the [solution design template](../templates/solution-design-template.md).

<!-- Avoid -->
See [this](../templates/solution-design-template.md).
```
