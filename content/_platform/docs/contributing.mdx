...
- **Templates**: See [Templates](/docs/platform/templates) for ready-to-use documentation templates
- **Guides**:
  - [Documentation Types](/docs/platform/guides/documentation-types) - When to use each type
  - [Diagram Guide](/docs/platform/guides/diagram-guide) - Working with PlantUML, Mermaid, and diagrams
  - [Writing Guide](/docs/platform/guides/writing-guide) - Style and formatting standards
...
See [Diagram Guide](/docs/platform/guides/diagram-guide) for detailed diagram usage.
...
- See [Documentation Types](/docs/platform/guides/documentation-types) to choose the right document type
- Use [Templates](/docs/platform/templates) for ready-to-use document templates
- Review [Diagram Guide](/docs/platform/guides/diagram-guide) for diagram best practices
- Follow [Writing Guide](/docs/platform/guides/writing-guide) for style conventions
