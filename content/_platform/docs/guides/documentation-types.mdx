...
**Template**: [ADR Template](/docs/platform/templates/adr)
...
**Template**: [Agreement Template](/docs/platform/templates/agreement)
...
**Template**: [Process Template](/docs/platform/templates/process)
...
**Template**: [Solution Design Template](/docs/platform/templates/solution-design)
...
**Template**: [Test Design Template](/docs/platform/templates/test-design)
...
**See**: [Diagram Guide](/docs/platform/guides/diagram-guide#c4-architecture-diagrams)
...
**Template**: [Sequence Diagram Template](/docs/platform/templates/sequence-diagram)
...
**Template**: [ERD Template](/docs/platform/templates/erd)
