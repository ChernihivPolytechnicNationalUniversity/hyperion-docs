...
```mdx
{/* Good */}
See the [diagram usage guide](/docs/platform/guides/diagram-guide) for details.

{/* Avoid */}
Click [here](/docs/platform/guides/diagram-guide) for details.
```
...
```mdx
{/* Good */}
See the [solution design template](/docs/platform/templates/solution-design).

{/* Avoid */}
See [this](/docs/platform/templates/solution-design).
```
