...
| Complex joins (user ↔ departments ↔ activities) | High |
| JSON support for flexible activity details | Medium |
| Full-text search for activity descriptions | Medium |
...
- **Moderate data volume** (~100GB projected over 5 years)
...
- Backup/recovery requires operational expertise
...
spring:
  datasource:
    url: jdbc:postgresql://localhost:5432/npp_portal
